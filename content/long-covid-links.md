Title: Long Covid Links
Date: 2025-10-09
slug: covid-talk-pycon-uk
Category: notes
tags: covid, talks, science
Summary: Some notes from a talk I gave at PyCon UK 2025
...
# How 'long' is it?
Longer than you'd think. The NHS website explains that [symptoms have to last more than 12 weeks](https://www.nhs.uk/conditions/long-covid/) to be counted as 'Long Covid' here in the UK. 
...
![Recovery over time graph]({filename}/images/fatigue-trajectories.jpeg)

Fatigue and cognitive problems are common after Covid. But recovery is also common. About half of people diagnosed with Long Covid in a German study [recovered spontaneously](https://pubmed.ncbi.nlm.nih.gov/38333368/) within two years, and a greater proportion saw their symptoms improve somewhat. 
...
# Aftermath
In the year after recovering from even a mild case of Covid you're about 40% more likely to develop [diabetes](https://pubmed.ncbi.nlm.nih.gov/36741600/) and have an increased chance of a [heart attack](https://www.nih.gov/news-events/news-releases/first-wave-covid-19-increased-risk-heart-attack-stroke-three-years-later) or a [stroke](https://www.stroke.org.uk/stroke/support/materials/stroke-news/stroke-and-covid-19-research-update).
...
I wound up with insomnia for quite a while afterwards, which turns out to be [surprisingly common](https://pubmed.ncbi.nlm.nih.gov/39436395/) especially in younger people. Watch out for worsening or new-onset anxiety or depression, too, as [these can also be triggered](https://www.yalemedicine.org/news/depression-and-anxiety-in-long-covid-why-interdisciplinary-treatment-is-needed) by Covid and need their own treatment.
...
![The vicious cycle]({filename}/images/pacing.png)
...
There is a link between latitude in the UK and health - the further north you go, the higher all-cause mortality rises. There are a lot of possible factors that might be behind this. But even when you control for the UK's [obvious north-south wealth divide](https://www.centreforcities.org/reader/levelling-up-the-uks-regional-economies/the-problem-of-regional-inequality/), there still seems to be something else at work here. 

![UK mortality vs latitude]({filename}/images/mortality-map.png)

Dr Richard Weller, a dermatologist, has a fascinating talk ['Why Are Scots So Sick'](https://www.youtube.com/watch?v=M1PQ_6NIqW8) where he lays out his theory that this is because sunlight exposure does something helpful in the skin. Specifically, he thinks UVA rays release stores of Nitric Oxide and that this helps to lower blood pressure on a population level. The further south you go, the more sunlight you can get, so the better heart health you might have.

Blue and green spaces are [good for our health in other ways](https://www.ncbi.nlm.nih.gov/books/NBK597114/) but this suggests sitting outside in the sunshine might be particularly helpful - not just supplementing vitamin D. Anecdotally, I always find I can concentrate better after a good spell in the sun.
...
![Choropleth map of Index of Multiple Deprivation 2019]({filename}/images/Peek.gif)

I made a map out of the [Index of Multiple Deprivation 2019](https://assets.publishing.service.gov.uk/media/5d8e26f6ed915d5570c6cc55/IoD2019_Statistical_Release.pdf) data for Local Authorities (with Python, of course!)

The Geographic Data Service has [a much better one](https://mapmaker.geods.ac.uk/#/index-of-multiple-deprivation?d=11110000&m=imdh19_dc&lon=-2.5&lat=53.7&zoom=7) broken down by Lower Super Output Area. Each LSOA is a combination of a few postcodes with perhaps 1000-3000 people total, so it's a really fine-grained look at neighbourhoods. 

The [Office for National Statistics](https://www.ons.gov.uk/peoplepopulationandcommunity/birthsdeathsandmarriages/deaths/bulletins/deathsinvolvingcovid19bylocalareasanddeprivation/deathsoccurringbetween1marchand31july2020) data shows that in England at the height of the pandemic, the age-standardised mortality rate for deaths involving COVID-19 in the most deprived areas was more than double the mortality rate in the least deprived areas. [Poverty leads to worse health](https://www.bbc.co.uk/news/health-57730353) and deprived areas tend to remain that way across generations, trapping people in cycles of inequality.
...
![Spoon collection]({filename}/images/SpoonCollection.jpg)
...
Keep an eye on Covid cases nearby to get a better understanding of what is happening. We now have the [UKHSA dashboard](https://ukhsa-dashboard.data.gov.uk/) for public health data which tracks Covid cases (and several other diseases) and even [breaks them down by local authority](https://ukhsa-dashboard.data.gov.uk/respiratory-viruses/covid-19?areaType=Lower+Tier+Local+Authority&areaName=Leeds). 

Set up your work environment for better health. Encourage anyone who is sick to take time off or work from home. [Good ventilation](https://www.who.int/publications/i/item/9789240021280) at work and in schools is another important way to mitigate ongoing spread of Covid. There's evidence [it can reduce the chances of developing a severe case](https://www.frontiersin.org/journals/public-health/articles/10.3389/fpubh.2024.1391719/full) if you do get infected. If you're in a position of authority at work then you can use it to help put these things in place for your colleagues - you will all benefit. Don't ever be embarrassed to ask to meet outside or in a less crowded environment, to turn up the air conditioning or open a window for fresh air.
