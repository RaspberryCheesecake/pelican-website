...
![Apple's Magic Mouse]({filename}/images/magic-mouse-photo.jpg)
...
![My Ordinary Mouse]({filename}/images/ordinary-mouse-photo.jpg)
...
There are no visible buttons on the Magic Mouse and no wheel for scrolling. Like a door without an obvious handle, it relies on your previous experience of using a mouse to make sense of it. You have to map what you know about mouse buttons and scrolling onto its blank surface, in order to use it. I didn't enjoy this, and I also missed the tactile feedback that I used to get from scrolling the mousewheel. It turns out that's quite important to me, especially when working on graphic design or video editing. I'm not ashamed to have returned to my dull old device, with its comfortable size, obvious buttons and [nineties-era](https://blog.codinghorror.com/meet-the-inventor-of-the-mouse-wheel/) scroll wheel. Those features are what helped me to use it easily.

# Apple and Design

Apple has a long history of being concerned with good design. They are famous for their focus on usability.  [This talk at an Apple Developer conference](https://developer.apple.com/videos/play/wwdc2017/802/) by expert Mike Stern is a great example of the kind of solid thinking they usually do in these areas. I often return to it when thinking about user interface design and making apps more accessible.

So they understand the problem. But the company seems to have lost its way a little bit when it comes to hardware. You may recall the controversy when it decided to [get rid of the headphone jack](https://www.bbc.co.uk/news/technology-37303181) on the iPhone 7. I still carry around a headphone adapter so that I can use my favourite (non-Apple) headphones with my iPhone, and [things may now have started to swing back in the other direction](https://www.pcgamer.com/hardware/7-years-after-declaring-it-took-courage-to-remove-the-iphones-headphone-jack-apple-has-finally-decided-buttons-and-ports-are-cool-again/). And then of course there's the Magic Mouse. I'm not the first person to dislike it.
...
You'll have heard of [minimalism](https://minimalissimo.com/interiors). These days it's code for throwing out all your stuff so you can live more simply, but it became a powerful force in modern architecture and design in the early twentieth century. 
...
![La Sagrada Familia]({filename}/images/Barcelona-Cathedral-Gaudi.JPG)
...
Gaudí did not separate interior and exterior with hard planes but intertwined them, [deliberately echoing the structure of a forest](https://pablolunastudio.com/gaudi-the-genius-in-transferring-nature-to-architecture/) and with some of the same advantages. His buildings still don't need much air conditioning even in a hot Barcelona summer because of the way they are designed to let air to flow through them, using decorative shutters to shade the rooms. He was [ahead of his time](https://www.researchgate.net/publication/329376539_Antonio_gaudi_the_forerunner_of_sustainability_and_biomimicry_in_architecture_100_years_in_advance) in looking for these solutions inspired by nature.
...
![The National Glass Centre in Sunderland]({filename}/images/NGC_006_ngc_front_facia_reduced.jpg)
...
> "I'm addressing a room - a football field! - full of people, and I'm afraid I don't know hardly anything about what all of you do... My association with you, if you want to call it that, began about two or three years ago when a computer scientist called me and said there were a group of people here in Silicon Valley that would pay $3000 to have dinner with me. I thought, what the hell is this!"
 ...
 He was greeted by programmers very enthusiastic to talk with him about 'design patterns' in software. [Richard Gabriel](https://dreamsongs.com/), then working at IBM, was one of the first software engineers to draw links between the architecture of buildings and the design of code. His thoughtful book [Patterns of Software: Tales from the Software Community](https://dreamsongs.com/Files/PatternsOfSoftware.pdf) was later published with a foreword by Alexander. Gabriel suggests we:

> "find good designers - know them by their works - and study what they do"

This led later down the line to things like the [Software Craftsmanship](https://manifesto.softwarecraftsmanship.org/) movement and op-eds [like this one by Freeman Dyson](https://www.science.org/doi/10.1126/science.280.5366.1014/) extolling the union of hand and mind in making useful things. People in software had woken up to the reality that they were practicing a *craft*, something that was half-art and relied on skills passed down from masters to journeymen. 
